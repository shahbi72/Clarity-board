...
- Starter ($25/mo): Shopify Orders CSV upload + basic insights.
- Business ($39/mo): Starter + Google Sheets live sync, change insights, and notification bell.
...
3. 7-day trial paywall enforcement
4. Business live sync:
   ...
   - Snapshot diffing and InsightEvent notifications
...
- `POST /api/cron/business-sync` (`x-cron-secret` required)
...
- `POST https://<your-domain>/api/cron/business-sync`
